      ...
      <div className="volantis-card overflow-hidden">
        ...
        <div className="relative z-10 p-8 md:p-12 text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[var(--color-border-light)] border border-[var(--color-border)] mb-6 animate-slide-down">
            <IconArchive size={16} className="text-[var(--color-primary)]" />
            <span className="text-sm font-medium text-[var(--color-text-muted)]">时光轴</span>
          </div>
          ...
          <p className="text-base md:text-lg text-[var(--color-text-muted)] max-w-2xl mx-auto leading-relaxed animate-slide-up animation-delay-200">
            按时间线浏览所有文章，记录技术成长的每一步
          </p>

          {/* Timeline icon decoration */}
          <div className="flex justify-center mt-6 animate-fade-in animation-delay-400">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[var(--color-primary)]/10">
              <IconTimeline size={20} className="text-[var(--color-primary)]" />
              <span className="text-sm text-[var(--color-text-muted)]">时间轴模式</span>
            </div>
          </div>
        </div>
      </div>
